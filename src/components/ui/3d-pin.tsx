    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2  flex justify-start items-start  rounded-2xl bg-background border border-border/[0.1] group-hover/pin:border-border/[0.2] transition duration-700 overflow-hidden"
        >
...
export const PinPerspective = ({
  ...
  return (
    <motion.div className="pointer-events-none mt-4 w-96 h-48 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
